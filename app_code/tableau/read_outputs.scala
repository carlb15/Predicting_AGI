...
val path1 = "hdfs:///user/mlu216/SHARE/OUTPUT/07/19/115045summary.parquet"
...
val path2 = "hdfs:///user/mlu216/SHARE/OUTPUT/07/19/115045pred.parquet"
val df2 = sqlCtx.parquetFile(path2)
df2.show(5)

//Training model coefficients (float coeff, string feature)

val path3 = "hdfs:///user/mlu216/SHARE/OUTPUT/07/19/115045coef.parquet"
